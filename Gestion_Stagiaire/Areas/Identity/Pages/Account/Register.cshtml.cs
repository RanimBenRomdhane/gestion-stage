        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Assign the 'Stagiaire' role to the user
                    if (!await _roleManager.RoleExistsAsync("Stagiaire"))
                    {
                        // If the role does not exist, create it
                        await _roleManager.CreateAsync(new IdentityRole("Stagiaire"));
                    }

                    await _userManager.AddToRoleAsync(user, "Stagiaire"); // Assign role to user
