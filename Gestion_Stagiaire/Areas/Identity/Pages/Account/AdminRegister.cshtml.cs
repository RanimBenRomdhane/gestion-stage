        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Ensure that Input.Role is not null or empty before checking for role existence
                    if (!string.IsNullOrEmpty(Input.Role))
                    {
                        ...
                        else
                        {
                            ...
                            {
                                // Handle error if the role could not be created
                    ...
                    {
                        // Handle the case where no role is provided, if necessary
