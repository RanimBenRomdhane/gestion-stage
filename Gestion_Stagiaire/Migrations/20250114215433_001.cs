        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nom_Departement = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Stage_Type = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypesStage", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type_StageId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    Path_Demande_Stage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Encadrant = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Titre_Projet = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Path_Rapport = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DemandesStage_Statuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Statuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DemandesStage_TypesStage_Type_StageId",
                        column: x => x.Type_StageId,
                        principalTable: "TypesStage",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DemandesStage_StatusId",
                table: "DemandesStage",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_DemandesStage_Type_StageId",
                table: "DemandesStage",
                column: "Type_StageId");
        }
